import {
  ...
  MenuItem,
  MenuList,
  Text, Tooltip, useBreakpointValue,
  useColorMode,
  ...
  return <Flex direction={"column"} w={"100%"}>
    <Flex w={'100%'} justify={'space-between'} align={'center'} p={"10px"}>
      ...
      <Flex>
        {
          !!prompt && !installed ?
          <Tooltip placement={"left"} label={"Installing Timetabl takes almost no storage or data, and allows you to have the full Timetabl experience."}>
