...
export default ({ name, icon: Icon, active, sidebar }) => {
  ...
  return <Flex _hover={{ bg: hoverColor }} pt={sidebar ? '0px' : '12px'} pb={sidebar ? '0px' : '16px'}
               mb={sidebar ? '12px' : '0px'} h={sidebar ? '56px' : '64px'} direction={'column'} w='80px'
               align={'center'}>
    ...
    <MotionFlex
      ...
      animate={
        { width: active ? (sidebar ? '56px' : '64px') : '0px' }
      }
      align={'center'}
